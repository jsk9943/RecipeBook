...
import { createContext, useContext, useMemo, useRef, useCallback, createElement, useState, useEffect, useLayoutEffect, Fragment, Component, Children, isValidElement } from 'react';
import { UNSAFE_invariant, resolveTo, joinPaths, matchPath, UNSAFE_getPathContributingMatches, UNSAFE_warning, parsePath, matchRoutes, Action, stripBasename, IDLE_BLOCKER, createMemoryHistory, AbortedDeferredError, createRouter, isRouteErrorResponse } from '@remix-run/router';
...
function useRoutesImpl(routes, locationArg, dataRouterState) {
  ...
  if (locationArg) {
    ...
    !(parentPathnameBase === "/" || ((_parsedLocationArg$pa = parsedLocationArg.pathname) == null ? void 0 : _parsedLocationArg$pa.startsWith(parentPathnameBase))) ?  UNSAFE_invariant(false, "When overriding the location using `<Routes location>` or `useRoutes(routes, location)`, " + "the location pathname must begin with the portion of the URL pathname that was " + ("matched by all parent routes. The current pathname base is \"" + parentPathnameBase + "\" ") + ("but pathname \"" + parsedLocationArg.pathname + "\" was given in the `location` prop."))  : void 0;
...
function DefaultErrorComponent() {
  ...
  let devInfo = null;
  {
    ...
    devInfo = /*#__PURE__*/createElement(Fragment, null, /*#__PURE__*/createElement("p", null, "\uD83D\uDCBF Hey developer \uD83D\uDC4B"), /*#__PURE__*/createElement("p", null, "You can provide a way better UX than this when your app throws errors by providing your own ", /*#__PURE__*/createElement("code", {
      style: codeStyles
    }, "ErrorBoundary"), " or", " ", /*#__PURE__*/createElement("code", {
      style: codeStyles
...
const defaultErrorElement = /*#__PURE__*/createElement(DefaultErrorComponent, null);
class RenderErrorBoundary extends Component {
  ...
  render() {
    return this.state.error ? /*#__PURE__*/createElement(RouteContext.Provider, {
      value: this.props.routeContext
    }, /*#__PURE__*/createElement(RouteErrorContext.Provider, {
...
function RouterProvider(_ref) {
  ...
  return /*#__PURE__*/createElement(Fragment, null, /*#__PURE__*/createElement(DataRouterContext.Provider, {
    ...
    navigator: navigator
  }, state.initialized ? /*#__PURE__*/createElement(DataRoutes, {
...
function Navigate(_ref4) {
  ...
  "<Navigate> may be used only in the context of a <Router> component.")  : void 0;
   UNSAFE_warning(!useContext(NavigationContext).static, "<Navigate> must not be used on the initial render in a <StaticRouter>. " + "This is a no-op, but you should modify your code so the <Navigate> is " + "only ever rendered in response to some user interaction or state change.") ;
  let {
    matches
  } = useContext(RouteContext);
  let {
  ...
  useEffect(() => navigate(JSON.parse(jsonPath), {
    replace,
    state,
    relative
...
function mapRouteProperties(route) {
  ...
  if (route.Component) {
    ...
    Object.assign(updates, {
      element: /*#__PURE__*/createElement(route.Component),
      Component: undefined
    });
  }
  if (route.ErrorBoundary) {
    ...
    Object.assign(updates, {
      errorElement: /*#__PURE__*/createElement(route.ErrorBoundary),
